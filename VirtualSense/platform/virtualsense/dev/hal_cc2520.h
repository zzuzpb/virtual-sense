...
#define CC2520_DISABLE_SPI_FUNC()       st( P5SEL &= ~(BV(5) | BV(4)); P3SEL &= ~(BV(7));)
...
#define CC2520_MISO_IPIN                (P5IN & BIT4)
         // For use in LPM - MCU_IO_SET(5,7,v)
#define CC2520_MISO_OPIN(v)             if(v) P5OUT |= BIT4;else P5OUT &= ~BIT4;
#define CC2520_MISO_DIR_IN()            P5DIR |= BIT4;                                          // MCU_PIN_DIR_OUT(5,7)
#define CC2520_MISO_DIR_OUT()           P5DIR &= ~BIT4;
...
#define CC2520_XOSC_MAX_STARTUP_TIME        500
#define CC2520_VREG_MAX_STARTUP_TIME        400
