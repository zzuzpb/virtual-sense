...
// per evitare problemi di overflow sar� necessario fare una differenza
// dal punto di reset (data nascita di Giulia) per� nel caso di settaggio
// della data a livello applicazione sar� necessario rinfrescare il punto di reset.
