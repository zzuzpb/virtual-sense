...
public class CTP
{
	...
	/*private static class CTP //implements CtpDataConsumer
	{
	...
	private static class ExampleProvider implements CtpDataProvider
	{
		public short[] getData()
		{
			...
			return new short[] 
			{
					(short)Runtime.getRuntime().freeMemory(),
					seq++,
	...
	public static void motemain()
    {
    	...
    	// Debug.setDisplayOutput(VirtualSense.getNodeId()==1);

    	// create a new CTP object
    	if (VirtualSense.getNodeId()==0)
    	{
    		// create sink
